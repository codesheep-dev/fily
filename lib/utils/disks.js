...
exports.getDefaultDiskDriver = exports.getDisk = void 0;
var config_1 = require("../env/config");
function getDisk(driver) {
    return __awaiter(this, void 0, void 0, function () {
        var config, disks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, config_1.getConfigFile()];
                case 1:
                    config = _a.sent();
                    if (!config) {
                    ...
                    return [2 /*return*/, disks.find(function (disk) { return disk.driver === driver; })];
            }
        });
    });
}
exports.getDisk = getDisk;
function getDefaultDiskDriver() {
    return __awaiter(this, void 0, void 0, function () {
        var config, disks, defaultDisk, disk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, config_1.getConfigFile()];
                case 1:
                    ...
                    disk = disks.find(function (item) { return item.driver === defaultDisk; });
                    if (!disk) {
                        throw new Error("A default disk was defined as " + defaultDisk + ", but no such disk could be found in the \"disks\" array.");
                    }
                    return [2 /*return*/, disk.driver];
            }
        });
    });
}
exports.getDefaultDiskDriver = getDefaultDiskDriver;
