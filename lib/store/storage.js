...
function store(file, options) {
    return __awaiter(this, void 0, void 0, function () {
        var filename, driver, _a, disk, _b, error_1;
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    switch (_b) {
                        ...
                        case disk_types_1.DISK_TYPES.FTP: return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 5:
                    if (!((options === null || options === void 0 ? void 0 : options.useExpressFileUpload) === true)) return [3 /*break*/, 6];
                    local_1.storeLocalWithExpressFileUpload(file, filename, disk);
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, local_1.storeLocal(file, filename, disk)];
                case 7:
                    _c.sent();
                    _c.label = 8;
                case 8: return [3 /*break*/, 12];
                case 9: return [4 /*yield*/, ftp_1.storeFtp(file, filename, disk)];
                case 10:
                    _c.sent();
                    return [3 /*break*/, 12];
                case 11: throw new Error("The provided disk type " + disk.type + " is not supported.");
