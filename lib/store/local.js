...
exports.storeLocal = exports.storeLocalWithExpressFileUpload = void 0;
 ...
 * @return void
 */
function storeLocalWithExpressFileUpload(file, filename, disk) {
    try {
        ...
        if (!!file.tmpPath && file.tmpPath !== '') {
            fs_1.rename(file.tmpPath, destination, function (error) {
                if (error)
...
exports.storeLocalWithExpressFileUpload = storeLocalWithExpressFileUpload;
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                destination = path_1.join(process.cwd(), disk.root);
                filesystem_1.checkExistingDiskRootFolder(destination);
                fs_1.rename(file.path, destination, function (error) {
                    if (error)
                        throw new Error("Something went wrong: " + error);
                });
            }
